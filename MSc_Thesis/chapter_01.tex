...
The weak nuclear force, which is responsible for the decay of the particles that is a flavour changing interaction, acts only on the fermions. Neutral and charged current interactions are mediated by the vector bosons of the this interaction, the Z boson and the W$^{\pm}$ bosons, respectively.

DIVE INTO THE ELECTROWEAK UNIFIED THEORY
