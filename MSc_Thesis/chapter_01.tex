...
In the \textbf{\emph{gluon fusion production}} mode, shown at \autoref{GGFH}, two gluons produce a Higgs boson via a fermion loop but this fermion is usually the top quark since the Higgs boson couples to massive particles more often. This production mode has a cross section of 48.6 pb at $\sqrt{13}$ TeV and at least one order of magnitude larger than the second likely production mode at the pp collisons. The Higgs boson produced in this mode in leading order, is expected to have a small transverse momentum which can ease the event selection to separate the Higgs signal from background processes. 
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.5]{higgs-br-vs-mH-complete.png}
