...
\begin{figure*}[ht]
        ...
        \end{subfigure}
        \caption[]
        {\small Feynman diagrams of the double Higgs bosons production via gluon fusion mechanism.}
        \label{ggF-HH}
\end{figure*}
