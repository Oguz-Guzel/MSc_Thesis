...
\be
\Lag_{EW} = \sum_\psi\bar\psi\gamma^\mu(i\partial_\mu -g_2\frac{1}{2}Y_WB_\mu-g\frac{1}{2}\sigma W_\mu)\psi
\ee
...
\be
\Lag_{QCD} = i\bar U (\partial_\mu-ig_3G_\mu^aT^a)\gamma^\mu U+i\bar D(\partial_\mu-ig_3G_\mu^aT^a)\gamma^\mu D ,
\ee
...
\be
 \Lag_{Higgs} = (D_\mu\phi)^\dagger(D^\mu\phi)-V(|\phi|^2) .
\ee
...
\be
 \begin{align}
 \frac{dV}{d\phi^\dagger\phi} &=\mu^2+2\lambda\phi^\dagger\phi = 0 \\
...
\be
V = -\frac{1}{2}m_h^2h^2-\sqrt{\frac{\lambda}{2}}m_hh^3-\frac{1}{4}\lambdah^4 ,
\ee
where $m_h = \sqrt{2\lambda}v$.
